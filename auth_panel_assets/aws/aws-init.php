...
<?php 
$i=$_GET['i'];//ap-south-1:66adf0fe-6c11-45d6-8d51-77fa00db3e49
$b=$_GET['b'];//'videocrypt-app';
$r=$_GET['r'];//'ap-south-1';
?>
let credentials = {
    IdentityPoolId: "<?php echo $i;?>"
};
var bucketName = "<?php echo $b; ?>"; // Enter your bucket name
// Initialize the Amazon Cognito credentials provider
AWS.config.region = "<?php echo $r ?>"; // Region
