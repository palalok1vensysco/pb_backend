...
//if (PAYTM_ENVIRONMENT == 'PROD') {
	...
	$PAYTM_MERCHANT_MID 		= "NEEKMA35045963877788";
	$PAYTM_MERCHANT_KEY 		= "%SIslAVzvopnhoet";

	$PAYTM_CHANNEL_ID 		= "WEB";
    $PAYTM_INDUSTRY_TYPE_ID = "ECommerce";
...
// 	//Change this constant's value with Merchant key received from Paytm.
// 	$PAYTM_MERCHANT_MID 		= "JLIRmB10559506708419";
// 	$PAYTM_MERCHANT_KEY 		= "dQlKub&6tq16VQJw";
