    ...
    public function ajax_season_list() {
       ...
       $sql .= " LIMIT " . $requestData['start'] . " ," . $requestData['length'] . "   ";
        ...
        foreach ($result as $r) {
            ...
            $nestedData[] = "<a class='btn-xs bold btn btn-primary' title='Edit' onclick=\"return confirm('Are you sure you want to Edit?')\" href='" . AUTH_PANEL_URL . "season/seasonController/edit_season/" . $r->id . "'><i class='fa fa-edit'></i></a>&nbsp;
				<a class='btn-xs bold btn btn-danger' title='Delete' onclick=\"return confirm('Are you sure you want to delete?')\" href='" . AUTH_PANEL_URL . "season/seasonController/delete_season/" . $r->id . "'><i class='fa fa-trash-o'></i></a>&nbsp;
