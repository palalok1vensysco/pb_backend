    ...
    <div class="col-lg-12">
        <section class="panel">
            <header class="panel-heading bg-dark text-white">
                Add Artist
                <a class="backBtn" href="<?= AUTH_PANEL_URL . 'Artist/artist/artist_list'; ?>">
                    <button class="btn btn-xs pull-right display_color text-white">Back</button>
                </a>
            ...
            <div class="panel-body bg-white">
                <form autocomplete="off" role="form" method= "POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="name" class="form-control" name = "name" id="name" placeholder="Enter Name" value="<?php echo set_value('name'); ?>"   maxlength="25" required oninput="checkpricee(this)">
