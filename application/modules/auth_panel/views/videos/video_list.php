...
$category = $this->db->get('video_category')->result_array();
?>
<div class="col-sm-12">
...
<div class="col-sm-12">
    <section class="panel">
        <header class="panel-heading">
            <? //php echo strtoupper($page);   ?>VIDEO(s) LIST
            ...
            <button class="btn-danger btn-xs btn delete_all"><i class="fa fa-trash">Delete All Selected</i></button>
                ...
                <table  class="display table table-bordered table-striped" id="all-video-grid">
                    <thead>
                        <tr>
                            ...
                            <th>Thumbnail </th>
                            <th>Video Preview</th>
<!--                            <th>Normal Or Sankirtan</th>-->
                            <th>Category</th>
                            <th>Normal Or Most Popular</th>
                  ...
                  <!--          <th>Creation time</th>-->
                    ...
                    <thead>
                        <tr>
                            ...
                            <th></th>
                            <th></th>
                            <th><select data-column="4"  class="search-input-select form-control">
                            ...
                            <th><select data-column="5"  class="search-input-select form-control">
                                    <option value="">All</option>
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-footer close-popup-model-footer">
                            <button class="close close_modal" aria-label='Close' data-dismiss='modal', type='button'>
                                <span aria-hidden='true'>×</span></button>
                        </div>
                        <div class="modal-body video-model-popup">
                            <div class="embed-responsive embed-responsive-16by9">
                                <iframe class="embed-responsive-item set_src" src="" height="300" width="640"  frameborder="0" allowfullscreen="1" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"></iframe>
                            </div>
                        </div>
                    </div>
                </div>
...
$custum_js = <<<EOD
        ...
        <script src="https://cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/10.15.5/sweetalert2.min.js" integrity="sha512-+uGHdpCaEymD6EqvUR4H/PBuwqm3JTZmRh3gT0Lq52VGDAlywdXPBEiLiZUg6D1ViLonuNSUFdbL2tH9djAP8g==" crossorigin="anonymous"></script>
              <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/10.15.5/sweetalert2.css" integrity="sha512-WfDqlW1EF2lMNxzzSID+Tp1TTEHeZ2DK+IHFzbbCHqLJGf2RyIjNFgQCRNuIa8tzHka19sUJYBO+qyvX8YBYEg==" crossorigin="anonymous" />
               <script type="text/javascript" language="javascript" >
                 var all_video_list = "$adminurl"+"videos/Video_control/ajax_all_video_list/";
                 var all_video_csv = "$adminurl"+"videos/Video_control/get_request_for_csv_download/";
        ...
        $(".delete_all").click(function(){
            var selected_ids = []
                ...
                if (selected_ids.length == 0) {
                    Swal.fire('Select atleast one row');
                    return false;
                }
                Swal.fire({
                    title: 'Are you sure?',
                    ...
                    if (result.isConfirmed) {
                          jQuery.ajax({
                            url :"$adminurl"+"videos/Video_control/delete_all_selected_data/", // json datasource
                            type: "post", // method , by default get
                            dataType: "json",
                            data: {
        ...
        <script>
            $(document).on('click','.preview',function(){
                var selector = $(this);
                let youtube_url = selector.attr('youtube_url');
                let yt_url = "https://www.youtube.com/embed/" + youtube_url + "?autoplay=1&enablejsapi=1&amp;origin=http%3A%2F%2Flocalhost&amp;widgetid=1";
		$('.set_src').attr('src', yt_url);
