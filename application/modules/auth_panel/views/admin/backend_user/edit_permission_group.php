...
<section class="panel">
    <header class="panel-heading displa_flex bg-dark">
        Make roles
        <?php 
            if(!empty($role_group)){
        ...
        ?>
        <?php if(APP_ID == 0){ ?>
            <a href="<?=AUTH_PANEL_URL?>admin/enable_functionality?app_id=<?=$app_id;?>" class="btn-xs btn pull-right display_color dropdown_ttgl text-white" >Enable Functionality</a>
        <?php } ?>
    </header>
