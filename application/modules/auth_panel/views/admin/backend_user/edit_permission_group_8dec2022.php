...
<section class="panel">
    <header class="panel-heading displa_flex">
        ...
        ?>
        <?php if(APP_ID == 0){ ?>
            <a href="<?=AUTH_PANEL_URL?>admin/enable_functionality?app_id=<?=$app_id;?>" class="btn-xs btn-success pull-right display_color" >Enable Functionality</a>
        <?php } ?>
    </header>
    <div class="panel-body">
        ...
        <form role="form" method="post" id="role">
            ...
            <div class="form-group col-md-12">
                ...
                <input type="text" placeholder="Enter role group name" name="permission_group_name" maxlength='50' class="form-control input-xs " value="<?= ($role_group) ? $role_group['permission_group_name'] : "" ?>" >
            ...
            <div class="panel-body">
                ...
                <div class="col-md-12">
                    <button class="btn btn-info pull-right btn-sm dropdown_ttgl text-white" type="submit">Submit</button>
                </div>
        </form>
    </div>
</section>
