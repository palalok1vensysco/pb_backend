...
<div class="col-sm-12 px-0">
    <section class="panel">
        <header class="panel-heading  bg-dark text-white">
            ...
            <a href="<?=AUTH_PANEL_URL;?>admin/create_backend_user" class="btn-xs btn pull-right display_color dropdown_ttgl text-white"><i class="fa fa-plus"></i>Add Backend User</a>
        </header>
