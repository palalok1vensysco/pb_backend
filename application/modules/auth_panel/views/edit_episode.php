        ...
        <div class="panel-body">
            <form role="form"  method="post" enctype="multipart/form-data" autocomplete="off" >
               ...
               <!--  <div class="form-group col-md-12 artists" style="display:<?php echo ($video_detail['artists_type']==''?'none':'block')?>">
                ...
                <div class="form-group col-md-12 upload_video_cls vod_url" style="display:<?php echo (strpos($video_detail['file_url'],'.m3u8')==true?'block':'none') ?>">
                 ...
                 <div class="form-group col-md-12 video_file_dash"  style="display:<?php echo (strpos($video_detail['file_url'],'.mpd')==true?'block':'none') ?>">
                ...
                <div class="form-group col-md-6 play_via" style="display:<?php echo ($video_detail['vdc_id']==''?'none':'block')?>">
                ...
                <div class="form-group col-md-6 playtime enter_class ">
                    ...
                    <input type="text" placeholder="Enter playtime in min." maxlength="5" name = "playtime" value="<?php echo $video_detail['playtime'] / 60 ?>" class="form-control input-xs">
              ...
              <!--   <div class="form-group col-md-12 video_thumbnail">
                 ...
                 <div class="form-group col-md-12">
                    <label>Video Portrait <button class="btn btn-info btn-xs content_thumb" type="button">Url</button></label>
                    <input type="file" accept="image/*" name = "thumbnail" class="form-control input-xs" >
                ...
                <div class="form-group col-md-12 video">
                    <label>Video Landscape <button class="btn btn-info btn-xs video_poster" type="button">Url</button></label>
                ...
                <div class="form-group radio col-sm-12"  >
                    ...
                    <input type="radio" name="movie_view" value="0" <?=($video_detail['view_mode']==0)?'checked':'checked'?>>FREE
                    <input type="radio" name="movie_view" value="1" <?=($video_detail['view_mode']==1)?'checked':''?>>PAID
                ...
                <div class="form-group col-md-12" >
                    ...
                    <div class="col-sm-12">
                        <textarea placeholder="Enter Description" class="form-control " name="description" rows="6" required><?php echo $video_detail['description'];?> <?php echo set_value('movie_desc'); ?></textarea>
                        <br>
                    </div>
