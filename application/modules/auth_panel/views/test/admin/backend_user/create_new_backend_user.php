        ...
        <div class="panel-body">
            <form action="" method="post" autocomplete="off">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control input-xs number" name="mobile" placeholder="Enter Mobile" value="<?php echo set_value('mobile') ?>">
                    <span class="text-danger"><?php echo form_error('mobile'); ?></span>
                </div>
                <div class="form-group col-md-6">
                    <label >User Name</label>
                    <input type="text" class="form-control input-xs" name="username" autocomplete="off" placeholder="Enter User Name" value="<?php echo set_value('username') ?>">
                    <span class="text-danger"><?php echo form_error('username'); ?></span>
                </div>
                <div class="form-group col-md-6">
                    <label >Password</label>
                    <input type="password" class="form-control input-xs" name="password" placeholder="Password" value="<?php echo set_value('password') ?>">
