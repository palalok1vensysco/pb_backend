...
<div class="col-lg-12">
    <section class="panel">
        <header class="panel-heading custom-panel-heading map_edit_categori text-white" style="background: var(--color1)!important">
            Edit Category
        ...
        <div class="panel-body bg-white p-2">
            <form autocomplete="off" role="form" method= "POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <select class="form-control input-sm m-bot15 selectpicker" name = "related_genres[]" id="rlguru" required="" multiple="" data-live-search="true">
                            <?php
                            if (isset($genres)) {
            ...
            <a href="<?= base_url('auth_panel/category/category/map_category') ?>">
