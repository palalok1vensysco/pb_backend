        ...
        <div class="panel-body bg-white p-2">
            <form autocomplete="off" role="form" method= "POST" enctype="multipart/form-data">
                   <div class="row">
                    ...
                    <input type="text" name="name"   id = 'cate' required class="form-control input-sm m-bot15" maxlength='50' oninput="this.value = this.value.replace(/[^a-z,A-Z ]/,'')" placeholder="Enter Category Name">
...
<div class="col-sm-12">
    <section class="panel">
        <header class="panel-heading bg-dark text-white">
            <button onclick="$('.add_file_element').show('slow');" class=" btn-xs btn pull-right display_color"><i class="fa fa-plus"></i> ADD</button>
            <span class="tools pull-right" style="margin-right: 5px;">
                    <form id="download_content_csv" method="post" action="<?= AUTH_PANEL_URL . "category/category/get_request_for_csv_download" ?>">
                         <button class="btn btn-xs btn-danger margin-right bold display_color clr_green"><i class="fa fa-file" aria-hidden="true"></i>Download CSV</button> 
...
$custum_js = <<<EOD
        ...
        jQuery(document).ready(function() {
                       ...
                       var dataTable = jQuery("#"+table).DataTable( {
                           ...
                           "order": [[ 0, "desc" ]],
                           "ajax":{
                               url :"$adminurl"+"category/category/ajax_category/", // json datasource
