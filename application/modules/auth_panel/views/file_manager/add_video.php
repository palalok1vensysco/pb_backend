...
$ams_bucket_name = 'vc-10002364-236416887402';
$cognito = 'ap-south-1:50a934f2-a817-4475-9f88-95f6fec1ba8d';

}
else if(APP_ID == 55){
    $ams_region = 'ap-south-1';
    $ams_bucket_name = 'vc-10002828-282817012502';
    $cognito = 'ap-south-1:bee05849-21aa-4c4f-a94c-58502e801a41';
}
else if(APP_ID == 56){
    $ams_region = 'ap-south-1';
    $ams_bucket_name = 'vc-10002865-286517030702';
    $cognito = 'ap-south-1:a9b2c152-6c53-45cc-97d3-c097b39c91b6';
}
 

// $ams_region = CHANG_REGION;
// $ams_bucket_name = CHANG_BUCKET_KEY;
// $cognito = CHANG_COGNITO ;
...
<div class="col-lg-6 no-padding add_file_element" id="add_file_col" style="display:none;">
    <section class="panel">
        <header class="panel-heading displa_flex align-items-center">
            Add Video  <header class="panel-heading displa_flex">

            <button class="btn btn-xs display_color f-600"  type="button" onclick="$('.add_file_element').hide('slow');" >Back</button>
        </header>
        </header>
            ...
            <form role="form"  method="post" enctype="multipart/form-data" id="add_video" autocomplete="off" >
                <div class="form-group h-64 col-md-12 ">
                    ...
                    <select class="form-control input-xs" name="video_type" >
                        ...
                        <option value="10"> Fast Live</option>
                        <?php }?>
                    ...
                    <div class="form-group h-64 col-md-12 by_method" style="display:none">
                        <label>Upload Methods<span style="color:#ff0000">*</span></label>
                        <select name="by_method" class="form-control input-xs" id="by_method">
                            <option value="">Choose Video Upload Methods</option>
                            <option value="1">By Mp4</option>
                            <option value="2">By Vdc Id</option>
                        </select>
                    </div>
                ...
                <div class="form-group col-md-12 channel_fast" style="display: none">
                    <label>Fast Channel List <span style="color:#ff0000">*</span></label>
                    <select name="fast_channels" class="form-control input-sm" id="fast_channels">
                        <option value="">Select Channel</option>
                         <?php
                        foreach ($fast_channel as $fast_channel_data) {
                            echo '<option value="' . $fast_channel_data['ch_id'] . '">' . $fast_channel_data['name'] . '</option>';
                        }
                        ?>
                    </select>
                </div>
                ...
                <div class="form-group col-md-12">
                 ...
                 <div class="form-group col-md-12 videocript_movie video-nput-2 trailer_field" style="display:none"> 
                    <label >Videocrypt Trailer ID</label>
                ...
                <div class="form-group col-md-12">
                    ...
                    <select class="form-control input-xs " name="lang_id"  id="lang_id">
                    <option value="">Select language</option>
                    <?php foreach ($languages as $language) { ?>
                             <option value="<?= $language['id']; ?>"><?= $language['lang_name']?></option>
                          <?php }?>
                    </select>
                    <span class="error bold"><?php echo form_error('languages'); ?></span>
                </div>
                ...
                <div class="form-group col-md-12 ">
                    ...
                    <input type="text" placeholder="Enter Title Here" name = "title" id="title"  class="form-control input-xs" >
                    <span class="error bold"><?php echo form_error('title'); ?></span>
                </div>
                ...
                <div class="form-group col-md-12 vod_vtt hide">
                ...
                <div class="form-group col-md-12 vod_srt hide">
               ...
               <div class="form-group col-md-12 channel_div" style="display: none">
                ...
                <div class="form-group col-md-12 video_thumbnail">
                    ...
                    <input type="file" accept="image/*" name = "thumbnail" id="thumbnailInputFile1" class="form-control input-xs" placeholder="Enter Thumbnail Url" required="">
               ...
               <!--  <div class="form-group col-md-6 Downloadclass">
                ...
                <?php if(APP_ID !=53){?>
                    <div class="form-group col-md-6 skip_intr"  style="height:58px;" >
                        
                        <input type="checkbox" id="skip_intr" name="skip_intr" value="1" onclick="skipIntr()">
                        <label>Attach Video</label>
                    </div>
                <?php }?>

                <div class="form-group col-md-6 skip_intro"  style="height:58px;" >
                    
                    <input type="checkbox" id="skip_intro" name="skip_intro" value="1" onclick="skipIntro()">
                    <label>Skip Intro</label>
                </div>
                
           <!--  <div class="form-group col-md-6 skip_intr" >
                    
                    <input type="checkbox" id="skip_intr" name="is_trending" value="1" onclick="skipIntrrr()">
 ...
 -->
               <!--  <div class="form-group col-md-6 seconds" style="display:none" >
                <label>Seconds</label>
                 ...
                 <div class="form-group col-md-6 seconds" style="display:none" >
                <label>Seconds</label> 
                    <input type="text" id="skip_time" class="form-control" maxlength="3" name="skip_time" min="1" id='skip' oninput="checkpriceee(this)" onkeydown="return (event.ctrlKey || event.altKey
                            || (47 < event.keyCode && event.keyCode < 58 && event.shiftKey == false)
                            || (95 < event.keyCode && event.keyCode < 106)
                            || (event.keyCode == 8) || (event.keyCode == 9)
                            || (event.keyCode > 34 && event.keyCode < 40)
                ...
                <!-- <div class="form-group col-md-6 sec" style="display:none" >
                 
                    <input type="text" hidden id="skip_timee"  value='1' name="skip_timee"  id='skip' >
                   
                </div> -->
                <?php if(isset($f_lists->paid) && $f_lists->paid == 1 ){ ?>
       <!--   <div class="form-group col-md-6 price_per_video" style="display:none">
                    <label>Price</label>
                    <input type="input" name ="ppv"  id="price_per_video" placeholder="Enter Price Per Video " class="form-control input-xs" oninput="checkprice(this)" onkeydown="return (event.ctrlKey || event.altKey
                            ...
                            || (event.keyCode == 8) || (event.keyCode == 9)
                            || (event.keyCode > 34 && event.keyCode < 40)
                            || (event.keyCode == 46))" maxlength="3">
                </div>  -->
    <?php } ?>
       
             
                <div class="form-group col-md-12 released_date">
                    <label for="published-date-user">Release Date <span style="color:#ff0000">*</span></label>
...
<div class="col-lg-6 hide_data_chk add_file_element_trailer" style="display:none;">
    <section class="panel ">
        <header class="panel-heading displa_flex">
            Video Preview
        </header>
        <div class="panel-body" id="test_player">
            <video  autoplay  controls preload="auto" id="video_player_aws_new" class="video-js vjs-default-skin" style="width:100%; height:300px; margin:auto;"></video>
        </div>
    </section>
</div>
...
<div class="col-sm-12 no-padding">
    <section class="panel">
        <header class="panel-heading ban-head-new displa_flex"><div> Video(s) List</div>
            ...
            <button onclick="$('.add_file_element').show('slow');" class="btn-xs btn display_color f-600 text-white"><i class="fa fa-plus"></i> Add</button>
            </div>
...
<script type="text/javascript" language="javascript" >
    jQuery(document).ready(function () {
        ...
        var dataTable = jQuery("#" + table).DataTable({
            ...
            "aoColumnDefs": [
                {"bSortable": false, "aTargets": [2,5,6,14]},
            ],
            "ajax": {
    ...
    $('select[name=video_type]').change(function () {
        ...
        if (videoType == '0') {
           ...
           $(".released_date").hide();
            ...
            if (by_method == 1) {
                $(".bitrat,.video_upload").show();
                alert("b");
            } else if (by_method == 2) {
                $(".videocript").show();

            } else {
                $(".bitrat,.video_upload,.videocript").hide();
            }
