        ...
        <div class="panel-body">
            <form role="form"  method="post" enctype="multipart/form-data" autocomplete="off" >
                ...
                <div class="form-group col-md-12">
                    ...
                    <select class="form-control input-xs category_type" name="cate_type" required="" id="category">
                 ...
                 <div class="form-group col-md-12 genres">
                    ...
                    <select class="form-control input-xs" id="main_geners" name="genres_type_general" required="">
                ...
                <div class="form-group col-md-12">
                    ...
                    <input type="text" placeholder="Enter Title Here" name = "title" id="title" maxlength='60' class="form-control input-xs" required="">
                    <span class="error bold"><?php echo form_error('title'); ?></span>
                </div>
