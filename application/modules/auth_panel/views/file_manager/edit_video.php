...
<style type="text/css">
    ...
    .vjs-seek-button.skip-back.skip-10.vjs-control.vjs-button .vjs-icon-placeholder , .vjs-seek-button.skip-forward.skip-30.vjs-control.vjs-button .vjs-icon-placeholder{
    ...
    <section class="panel">
        <header class="panel-heading displa_flex align-items-center justify-content-between">
            <span>Edit Video  </span>                 
                 <button class="btn btn-xs display_color f-600 text-white"  type="button" > <a href="javascript:history.back()" class="text-white">Go Back</a></button>        
        </header>
            ...
            <form role="form"  method="post" enctype="multipart/form-data" autocomplete="off" >
                <div class="form-group col-md-12 ">
                    ...
                    <select class="form-control input-xs" name="video_type" >
                        ...
                        <option value="7" <?= ($video_detail['video_type'] == '7') ? 'selected' : '' ?> > VOD</option>
                       
                        <?php 
                        if(isset($f_lists->Videocrypt_Live) && $f_lists->Videocrypt_Live == 1 || APP_ID == 0){ ?>
                        <option value="8"  <?= ($video_detail['video_type'] == '8') ? 'selected' : '' ?>> Live</option>
                        <?php }?>
                        <!-- <option value="0" >Normal</option> -->

                        <?php if(isset($f_lists->Videocrypt_Fast_Live) && $f_lists->Videocrypt_Fast_Live == 1 || APP_ID == 0){ ?>
                        <option value="10"  <?= ($video_detail['video_type'] == '10') ? 'selected' : '' ?>> Fast Live</option>
                        <?php }?>
                ...
                <div class="form-group col-md-12 videocript video-nput-2" style="display:<?php echo ($video_detail['vdc_id']==''?'none':'block')?>">                   
                    <div class="videoEditTd">
                        <div class="w-100">
                            <label >VideoCrypt ID</label>
...
<!-- 
               ...
               <!--  <div class="form-group col-md-12 artists" style="display:<?php echo ($video_detail['artists_type']==''?'none':'block')?>">
                 ...
                 <div class="form-group col-md-12 artists">
                        <label for="rlguru">Artists</label>
                ...
                <div class="form-group col-md-12 agg"  >
                    <label class="control-label  pl-0" ><strong>Aggregator</strong></label>
                    <select name="aggregator" class="form-control input-xs">
                        
                    <option value="0">No Aggregator</option>
                        <?php foreach($agg_detail as $key => $val){ ?>

                        <option value="<?= $val['id'] ?>" <?php if($val['id'] == $video_detail['aggregator_id']){echo("selected");}?>><?= $val['name'] ?></option>
                        <?php } ?>
                    </select>
                ...
                <div class="form-group col-md-12 genres" >
                    ...
                    <span id="genresmsg" style="color: red;"></span>
                </div>

                <div class="form-group col-md-12">
                    <label >Video Title</label>
                    <input type="text" placeholder="Enter title" name = "title" id="title" maxlength='100' value = "<?php echo $video_detail['title'] ?>" class="form-control input-xs">
                ...
                <div class="form-group col-md-12 hide  ">
                    ...
                    <input type="text" placeholder="Enter title" name = "transcribe" id="transcribe"  value = '<?php echo $video_detail['transcribe'] ?>' class="form-control input-xs">
                ...
                <div class="form-group col-md-12 live_start_date" style="display:none">
                    ...
                    <input name="start_date" id="start_date" value="" placeholder="Select live start date Time" class="form-control input-xs ">
                     ...
                     <div class="form-group col-md-12 upload_video_cls vod_url <?php if($video_detail['video_type'] == '4'){ echo "";}else{echo "hide";}?>" >
              ...
              <!--   <div class="col-md-12 video_genres">
                ...
                <div class="form-group col-md-6 is_drm" >
                    ...
                    <select class="form-control input-xs" name="is_drm_protected">
                        <option value="0"<?php if($video_detail['is_drm_protected']==0){ echo "selected"; }?>>No</option>
                        <option value="1" <?php if($video_detail['is_drm_protected']==1){ echo "selected"; }?>>Yes</option>
                    </select>
                </div>
                ...
                <div class="form-group col-md-6 released_date">
                    ...
                    <div data-date-format="yyyy-mm-dd" data-date="2013/12/1">
                        ...
                        $timestamp = $video_detail['published_date'];
                        // pre($timestamp);
                        //     $date = date('d/m/Y', $timestamp);
                        //    pre($date);die;
                           
                        ?>
                        <input class="form-control published-date-user" type="date" name="published_date" id="published-date-user" placeholder=" Select Published Date From"  max="<?php echo date("Y/m/d"); ?>" value="<?php if(isset($timestamp)){echo date('Y-m-d', $timestamp);} ?>">
                    </div>
               ...
               <div class="form-group col-md-12 channel_div" style="<?php if(!empty($video_detail['channel_id'])){echo "display :block";}else{ echo "display: none"; } ?>">
                ...
                <div class="form-group col-md-12 channel_fast" style="<?php if(!empty($video_detail['channel_id'])){echo "display :block";}else{ echo "display: none"; } ?>">
                    <label>Fast Channel List</label>
                    <select name="fast_channels" class="form-control input-sm" id="fast_channels">
                        <option value="">Select Fast Data</option>
                        <?php
                        foreach ($fast_channel as $fast_channel_data) {
                                if($fast_channel_data['id']==$fast_channel_data['channel_id']){
                                    $varselecte = "selected"; 
                                }else{
                                    $varselecte = ""; 
                                }  
                                echo $varselecte;
                            echo '<option value="' . $fast_channel_data['id'] . '" '.$fast_channel_data.' >' . $fast_channel_data['name'] . '</option>';
                        }
                        ?>
                    </select>
                </div>
              ...
              <!--   <div class="form-group col-md-12 video_thumbnail">
                 ...
                 <div class="col-md-12">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="file" accept="image/*" name = "thumbnail" class="form-control input-xs" id="thumbnailInputFile1" >
                    ...
                    <div class="form-group col-md-6 video">
                        ...
                        <input type="file" accept="image/*" name = "poster" class="form-control input-xs" id="posterInputFile1" >
              ...
              <!-- attach code start -->
              <?php if(APP_ID !=53){?>
               <div class="form-group col-md-6 skip_intr" style="<?php if(!empty($video_detail['attach_video'])){echo "display";}else{ echo "display: none"; } ?>">
                    
                    <input type="checkbox" id="skip_intr" name="skip_intr" value="1" onclick="skipIntr()" <?=($video_detail['attach_video']==1)?'checked':''?>>
              ...
              <!-- attch code end -->
                ...
                <label>Seconds</label> 
                    <input type="text" id="skip_time" maxlength="3" name="skip_time"  id='skip' oninput="checkpricee(this)" onkeydown="return (event.ctrlKey || event.altKey
                            ...
                            || (event.keyCode == 46))" value="<?php echo $video_detail['skip_time'] ?>">
...
<div class="col-lg-6 hide_data_chk">
      <section class="panel">
        ...
        <div class="panel-body">
          <?php if ($video_detail['video_type'] == "1" ||  $video_detail['video_type'] == "4") { ?>

            <video id="video_player_aws_new1" data-setup='{ "techOrder": ["youtube"], "sources": [{ "type": "video/youtube", "src": "<?= "https://www.youtube.com/watch?v=" . $video_detail['file_url']; ?>"}] } ' class="video-js vjs-default-skin m-auto" autoplay controls preload="auto"  style="width:100%; min-height:300px; margin:auto;max-height:300px !important;"></video>

          <?php } else { ?>
            <video  id="video_player_aws_new" class="video-js vjs-default-skin m-auto" autoplay controls preload="auto" style="width:100%; min-height:300px; margin:auto; max-height:300px !important;"></video>
          <?php } ?>
          <?php 
         $array_data = '['.$video_detail['transcribe'].']';
          $json_t = json_decode($array_data, true);
         // pre($json_t);
         ?>
         <?php foreach ($json_t as $item) { ?>
     ...
     <!--<video width="450" height="300" controls hidden="" onloadedmetadata="function_name()" id="videoid">-->
...
<div class="hide">
      <video width="450" height="300" controls hidden="" onloadedmetadata="load_video_play_time()" id="videoid">
        <source src="" id="video_here">
        Your browser does not support HTML5 video.
      </video>
...
<script type="text/javascript">
  ...
  var video_url = "<?= "https://www.youtube.com/watch?v=" . $video_url; ?>";
  var video_urls = "<?= $video_url; ?>";
  if (video_type == "1" || video_type == "4") { //youtube

    init_shaka_player("video_player_aws_new1", video_url, 'youtube', '');
    $('#video_player_aws_new').hide();

  } else if (video_type == "11") { //for ivs
    init_shaka_player("video_player_aws_new", video_urls, 'm3u8', '');
    $('#video_player_aws_new1').hide();

  } else if (video_type == "5" || video_type == "7" || video_type == "8") { //aws
    let cfData = {
      name: <?= $video_detail['id']; ?>,
      url: ((video_type == 5 || video_type == 8) ? "<?= $video_url; ?>" : "<?= $video_detail['vdc_id'] ?>"),
      ...
      $.ajax({
        ...
        success: function(data) {
          if (data.data == 1) {
            init_shaka_player("video_player_aws_new", data.url, data.type, data.token);
            $('#video_player_aws_new1').hide();
          } else {
...
<script type="text/javascript" language="javascript" >
    ...
    function get_genres(){
        ...
        $.ajax({
               ...
               $("#genresmsg").text("Please add genres by selecting category.!");
              // document.getElementById("genresmsg").textContent="Genres not added";
               }
    ...
    $("#video_search").click(function(){ 
        ...
        if(vid==""){
            alert( "Please Enter videocript Id ");
        }
        if(vid!=""){
            jQuery.ajax({
