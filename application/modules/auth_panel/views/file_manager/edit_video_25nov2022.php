...
<div class="col-lg-6 no-padding">
    <section class="panel">
        <header class="panel-heading">
            Edit Video                   
                 <button class="btn btn-xs display_color"  type="button" > <a href="javascript:history.back()">Go Back</a></button>        
        </header>
...
<!-- 
               ...
               <!--  <div class="form-group col-md-12 artists" style="display:<?php echo ($video_detail['artists_type']==''?'none':'block')?>">
                ...
                <div class="form-group col-md-12">
                    ...
                    <input type="text" placeholder="Enter title" name = "title" id="title" maxlength='60' value = "<?php echo $video_detail['title'] ?>" class="form-control input-xs">
               ...
               <!--  <div class="form-group col-md-6">
                  ...
                  <div class="form-group col-sm-6"  >
                    ...
                    <select name="movie_view" class="form-control input-xs">
                        ...
                        <?php if(isset($f_lists->paid) && $f_lists->paid == 1 || APP_ID == 0){ ?>
        ...
        <div class="panel-body" id="test_player">
           ...
           <!--  <video width="450" autoplay  controls preload="auto" height="300" id="video_player_aws_new" class="video-js vjs-default-skin" ></video> -->
            ...
            <?php  if ( $video_detail['video_type'] == "1" ||  $video_detail['video_type'] == "4") {?>    
                 ...
                 <video width="450" height="300" id="video_player_aws_new1"  data-setup='{ "techOrder": ["youtube"], "sources": [{ "type": "video/youtube", "src": "<?= "https://www.youtube.com/watch?v=".$video_detail['file_url']; ?>"}] } '  class="video-js vjs-default-skin m-auto" autoplay controls preload="auto" ></video>
 
        <?php }  else{ ?>
           <!--    <video width="450" height="300" id="video_player_aws_new" class="video-js vjs-default-skin m-auto" autoplay controls preload="auto"></video>   -->
