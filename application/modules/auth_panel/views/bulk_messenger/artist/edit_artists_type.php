...
<div class="col-lg-12">
    <section class="panel">
        <header class="panel-heading custom-panel-heading text-white d-flex justify-content-between align-items-center" style="background: var(--color1)!important">
            ...
            <button class="btn display_color pull-right text-white f-600" type="button"><a href = "javascript:history.back()" class="text-white">Back To Previous Page</a></button>
        </header>
        <div class="panel-body bg-white p-2">
            <form autocomplete="off" role="form" method= "POST" enctype="multipart/form-data">
             ...
             <div class="col-md-12">
                ...
                <button class="btn btn-sm display_color text-white f-600" type="button" onclick="window.location.href='<?php echo site_url('auth_panel/Artist/artist/add_artists_type');?>'">Cancel</button>
