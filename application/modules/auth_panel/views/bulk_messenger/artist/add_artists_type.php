    ...
    <section class="panel">
        <header class="panel-heading bg-dark text-white d-flex justify-content-between align-items-center flex-direction-reverse">
            ...
            <span class="tools pull-right" style="margin-right: 5px;">
                    <form id="download_content_csv" method="post" action="<?= AUTH_PANEL_URL . "Artist type/Artist type/get_request_for_csv_download" ?>">
...
$custum_js = <<<EOD
    ...
    if (input.value == 0) {
      input.setCustomValidity('The Artist type value must not be zero.');
    } else {
